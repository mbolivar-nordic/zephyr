...
${PYTHON_EXECUTABLE_OUT_OF_SYNC}")
  ...
  # Set WEST to a COMMAND prefix as if it were a find_program() result.
  if(${west_version} VERSION_GREATER_EQUAL 0.8)
    # The 'west' package became runnable as a module during 0.8
    # development.
    set(WEST_MODULE west)
  else()
    # In west 0.7.x, it's possible to run west.app.main. Simplify this
    # once 0.8.0 is the minimum supported version.
    set(WEST_MODULE west.app.main)
  endif()
